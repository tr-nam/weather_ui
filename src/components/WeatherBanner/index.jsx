...
//     const baseOpacity = 0.6 + (precipitationProbability / 100) * 0.3;
//     const baseWidth = 8 + (precipitationProbability / 100) * 12;
//     return Array.from({ length: count }).map(() => ({
//       x: (Math.random() - 0.5) * 30,
//       y: 10 + Math.random() * 5,
//       z: (-1 + Math.random() - 0.5) * 20,
...
//       mountainGroup.position.set(0, -15, -20);
//       mountainGroup.scale.set(50, 50, 50);
...
//   useEffect(() => {
//     console.log('WeatherEffect rendered', props);
//   }, [props]);

//   return (
//     <div className="relative w-full h-[360px]">
//       <Canvas camera={{ position: [0, 0, 10], fov: 55 }} shadows={false}>
//         <WeatherScene
